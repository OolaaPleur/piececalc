...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "dataSuccessfullyUploadedToApp" : MessageLookupByLibrary.simpleMessage("Данные успешно загружены в приложение."),
    ...
    "exportBackupToFile" : MessageLookupByLibrary.simpleMessage("Экспортировать резервную копию в файл"),
    "february" : MessageLookupByLibrary.simpleMessage("${Intl.plural(day, zero: 'Февраль', other: 'Февраля')}"),
    "fileIsDamaged" : MessageLookupByLibrary.simpleMessage("Файл поврежден."),
    "fileIsNotCorrect" : MessageLookupByLibrary.simpleMessage("Файл не корректен."),
    ...
    "hoursOnly" : m0,
    "importBackupFromFile" : MessageLookupByLibrary.simpleMessage("Импортировать резервную копию из файла"),
