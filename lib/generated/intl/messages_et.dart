...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "archiveThreeDotMenu" : MessageLookupByLibrary.simpleMessage("Arhiveeri"),
    "archivedWorksArentShowingInAddTaskWorkSuggestions" : MessageLookupByLibrary.simpleMessage("Arhiveeritud töid ei kuvata ülesande lisamise ettepanekutes."),
    ...
    "backupOfMyData" : MessageLookupByLibrary.simpleMessage("Minu andmete varukoopia"),
    ...
    "chartGuideDaysOnTheXaxisMoneyEarnedOnThe" : MessageLookupByLibrary.simpleMessage("🔍 Graafiku juhend: päevad x-teljel. Teenitud raha y-teljel."),
    "commentForTask" : MessageLookupByLibrary.simpleMessage("Kommentaar ülesandele"),
    "couldNotLaunch" : MessageLookupByLibrary.simpleMessage("Ei suutnud käivitada"),
    "dark" : MessageLookupByLibrary.simpleMessage("Tume"),
    "dataSuccessfullyUploadedToApp" : MessageLookupByLibrary.simpleMessage("Andmed edukalt rakendusse üles laetud."),
    ...
    "exportBackupToFile" : MessageLookupByLibrary.simpleMessage("Ekspordi varukoopia faili"),
    "february" : MessageLookupByLibrary.simpleMessage("Veebruar"),
    "fileIsDamaged" : MessageLookupByLibrary.simpleMessage("Fail on kahjustatud."),
    "fileIsNotCorrect" : MessageLookupByLibrary.simpleMessage("Fail ei ole korrektne."),
    "friday" : MessageLookupByLibrary.simpleMessage("Reede"),
    "hereIsMyBackupFromPiececalc" : MessageLookupByLibrary.simpleMessage("Siin on minu varukoopia PieceCalc-st."),
    "homeBottomNavBarTitle" : MessageLookupByLibrary.simpleMessage("Ajajoon"),
    "hourWork" : MessageLookupByLibrary.simpleMessage("Tunnitöö"),
    "hoursOnly" : m0,
    "importBackupFromFile" : MessageLookupByLibrary.simpleMessage("Impordi varukoopia failist"),
    ...
    "introSecondAndHalfScreenBody" : MessageLookupByLibrary.simpleMessage("PieceCa(lc) abil sorteeritakse sinu ülesanded automaatselt kuude kaupa. See muudab sinu edusammude ülevaatamise ja jälgimise lihtsamaks kui kunagi varem."),
    "introSecondAndHalfScreenHeader" : MessageLookupByLibrary.simpleMessage("Kuuline korraldus 📅"),
    "introSecondScreenBody" : MessageLookupByLibrary.simpleMessage("Arvuta tehtud töö maht ühe klõpsuga ja saa kohe selge, organiseeritud ülevaade."),
    "introSecondScreenHeader" : MessageLookupByLibrary.simpleMessage("Kohene töö arvutamine 💹"),
    "introSixthScreenBody" : MessageLookupByLibrary.simpleMessage("Sukeldu PieceCa(lc)\'i ja alusta oma töö arvutamist täna organiseeritumalt ja tõhusamalt!"),
    "introSixthScreenHeader" : MessageLookupByLibrary.simpleMessage("Valmis alustama? 🚀"),
    "introThirdScreenBody" : MessageLookupByLibrary.simpleMessage("Ära karda andmekadu. Looge kõigi oma andmete või mis tahes kuu konkreetsete ülesannete jaoks hõlpsasti varukoopiad."),
    "introThirdScreenHeader" : MessageLookupByLibrary.simpleMessage("Turvaline varundus 🛡️"),
    ...
    "selectColorShade" : MessageLookupByLibrary.simpleMessage("Vali värvi varjund"),
    "selectTime" : MessageLookupByLibrary.simpleMessage("Vali aeg"),
    "selectedColorAndItsShades" : MessageLookupByLibrary.simpleMessage("Valitud värv ja selle varjundid"),
    ...
    "unarchiveThreeDotMenu" : MessageLookupByLibrary.simpleMessage("Eemalda arhiivist"),
    ...
    "worksHasntBeenArchivedYetToArchiveWorkTapThreedot" : MessageLookupByLibrary.simpleMessage("Tööd pole veel arhiveeritud. Arhiveerimiseks klõpsake tööloendi plaadil kolmepunktimenüül ja valige \'Arhiveeri\'."),
